(function() {
    ...
    const domSectFnSrc = document.getElementById("sectFnSrc");
    ...
    const domFnSrcCode = document.getElementById("fnSrcCode");
    ...
    function render() {
        ...
        domSectFnSrc.classList.add("hidden");
    ...
    function renderFunction(decl_index) {
      ...
      renderTopLevelDocs(decl_index);
      domFnSrcCode.innerHTML = declSourceHtml(decl_index);

      domSectFnSrc.classList.remove("hidden");
