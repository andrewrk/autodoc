(function() {
    ...
    var zigAnalysis = {
      ...
      calls: [],
      packages: [
        {name: "", file: 0, main: 0, table: { root: 0 }},
      ],
      types: [
        {kind: 0, name: "type"},
      ],
    ...
    WebAssembly.instantiateStreaming(wasm_promise, {
      ...
      sources_promise.then(function(buffer) {
        ...
        nodesToFnsMap = indexNodesToFns();
        nodesToCallsMap = indexNodesToCalls();
    ...
    function fullyQualifiedName(global_ast_node) {
      const ptr = wasm_exports.fully_qualified_name(global_ast_node);
      const len = wasm_exports.fully_qualified_name_len();
