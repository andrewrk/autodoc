(function() {
    ...
    const CAT_primitive_undefined = 9;
    const CAT_alias = 10;
    ...
    var domSectSource = document.getElementById("sectSource");
    var domSectTypes = document.getElementById("sectTypes");
    var domSectValues = document.getElementById("sectValues");
    var domSourceText = document.getElementById("sourceText");
        ...
        switch (curNav.tag) {
          ...
          case 2:
            if (curNav.decl == null) {
              ...
              return renderSource(curNav.decl);
            }
    ...
    function updateCurNav() {
        ...
        if (location.hash[0] === '#' && location.hash.length > 1) {
            ...
            if (nonSearchPart.length > 0) {
              ...
              if (source_mode) {
                const fqn = nonSearchPart.substring(4);
                curNav.tag = 2;
                curNav.decl = findDecl(fqn);
              } else {
                curNav.tag = 1;
