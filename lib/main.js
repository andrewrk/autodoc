(function() {
    ...
    function renderHome() {
      if (moduleList.length == 1) return renderModule(0);

      domStatus.textContent = "TODO implement renderHome for multiple modules";
    ...
    function renderDecl(decl_index) {
      ...
      switch (category) {
        ...
        case CAT_global_variable: return renderGlobal(decl_index);
        case CAT_function: return renderFunction(decl_index);
        case CAT_primitive: return renderGlobal(decl_index);
        case CAT_error_set: return renderErrorSetPage(decl_index);
        case CAT_global_const: return renderGlobal(decl_index);
        case CAT_alias: return renderDecl(wasm_exports.get_aliasee());
        case CAT_type: return renderGlobal(decl_index);
    ...
    function startAsyncSearch() {
      clearAsyncSearch();
      searchTimer = setTimeout(startSearch, 30);
    }
